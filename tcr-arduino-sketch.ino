...
#define div1 0                                    // reference resistor
#define R_ref1 33000                              
#define R_ref2 33000
const int B = 3950;                               // the beta of the thermistor
const float R0 = 10000.0;                         // starting resistance

void setup()
{
  Serial.begin(9600);
  pinMode(div1, INPUT);                           // to read voltage at the voltage divider of the test resistor
  pinMode(div2, INPUT);                           // to read voltage at the voltage divider of the thermistor
...
void loop()
{
  ...
  lcd.print("R_test:");                                
  lcd.print(R_test);                                   // print the test resistors resistance to the LCD.
